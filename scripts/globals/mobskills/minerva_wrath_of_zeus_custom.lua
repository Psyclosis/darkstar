...
function onMobWeaponSkill(target, mob, skill)
    ...
    mob:addStatusEffect(dsp.effects.SHOCK_SPIKES, 10, 0, 600);
    mob:SetMobSkillAttack(0);
    target:addStatusEffect(dsp.effects.SILENCE, 1, 0, 90);
    mob:addStatusEffectEx(dsp.effects.CUSTOM_ENSPELL, EFFECT_ENTHUNDER, 5, 0, 600);
    target:delHP(dmg);
